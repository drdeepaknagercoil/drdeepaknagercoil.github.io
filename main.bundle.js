...
var TestimonialComponent = (function () {
    function TestimonialComponent(afAuth, af) {
        this.afAuth = afAuth;
        this.af = af;
        this.msgVal = '';
    ...
    TestimonialComponent.prototype.login = function () {
        this.afAuth.auth.signInAnonymously();
    };
    TestimonialComponent.prototype.logout = function () {
        this.afAuth.auth.signOut();
    };
    TestimonialComponent.prototype.Send = function (desc) {
